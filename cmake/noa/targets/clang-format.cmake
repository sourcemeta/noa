set(NOA_TARGETS_CLANG_FORMAT_DIRECTORY "${CMAKE_CURRENT_LIST_DIR}")

function(noa_targets_clang_format)
  cmake_parse_arguments(NOA_TARGETS_CLANG_FORMAT "REQUIRED" "" "SOURCES" ${ARGN})

  if(NOA_TARGETS_CLANG_FORMAT_REQUIRED)
  ...
  if(NOT NOA_TARGETS_CLANG_FORMAT_SOURCES)
    message(FATAL_ERROR "You must pass file globs to format in the SOURCES option")
  endif()
  file(GLOB_RECURSE NOA_TARGETS_CLANG_FORMAT_FILES
    ${NOA_TARGETS_CLANG_FORMAT_SOURCES})

  set(CLANG_FORMAT_CONFIG "${NOA_TARGETS_CLANG_FORMAT_DIRECTORY}/clang-format.config")
  if(CLANG_FORMAT_BIN)
    add_custom_target(clang_format
      WORKING_DIRECTORY "${PROJECT_SOURCE_DIR}"
      VERBATIM
      COMMAND "${CLANG_FORMAT_BIN}" "--style=file:${CLANG_FORMAT_CONFIG}"
        -i ${NOA_TARGETS_CLANG_FORMAT_FILES}
